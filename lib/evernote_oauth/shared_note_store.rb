module EvernoteOAuth
  ...
  class Client
    def shared_note_store(shared_notebook, options={})
      EvernoteOAuth::SharedNoteStore.new(
        ...
        :client => thrift_client(::Evernote::EDAM::NoteStore::NoteStore::Client, shared_notebook.noteStoreUrl)
      )
    end
  end
  ...
  class SharedNoteStore
    ...
    def initialize(options={})
      ...
      @token = authenticateToSharedNotebook(@shared_notebook.shareKey, options[:token]).authenticationToken
    end
  end
